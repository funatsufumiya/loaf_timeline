...
static int _wrap_Client_set__SWIG_1(lua_State* L) { { int SWIG_arg = 0; ofxSyphonClient *arg1 = (ofxSyphonClient *) 0 ;
    ...
    if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ofxSyphonClient,0))){
      SWIG_fail_ptr("Client_set",1,SWIGTYPE_p_ofxSyphonClient); }  temp2.assign(lua_tostring(L,2),lua_rawlen(L,2)); arg2=&temp2;
    temp3.assign(lua_tostring(L,3),lua_rawlen(L,3)); arg3=&temp3;
    (arg1)->set((std::string const &)*arg2,(std::string const &)*arg3); return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L);
  return 0; }
...
static int _wrap_Client_setApplicationName(lua_State* L) { { int SWIG_arg = 0; ofxSyphonClient *arg1 = (ofxSyphonClient *) 0 ;
    ...
    temp2.assign(lua_tostring(L,2),lua_rawlen(L,2)); arg2=&temp2; (arg1)->setApplicationName((std::string const &)*arg2);
...
static int _wrap_Client_setServerName(lua_State* L) { { int SWIG_arg = 0; ofxSyphonClient *arg1 = (ofxSyphonClient *) 0 ;
    ...
    if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ofxSyphonClient,0))){
      SWIG_fail_ptr("Client_setServerName",1,SWIGTYPE_p_ofxSyphonClient); } 
    temp2.assign(lua_tostring(L,2),lua_rawlen(L,2)); arg2=&temp2; (arg1)->setServerName((std::string const &)*arg2);
    return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
static int _wrap_Client_getApplicationName(lua_State* L) { { int SWIG_arg = 0; ofxSyphonClient *arg1 = (ofxSyphonClient *) 0 ;
    ...
    result = (std::string *) &(arg1)->getApplicationName(); lua_pushlstring(L,result->data(),result->size()); SWIG_arg++;
    return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
...
static int _wrap_Client_bind(lua_State* L) { { int SWIG_arg = 0; ofxSyphonClient *arg1 = (ofxSyphonClient *) 0 ;
    ...
    if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ofxSyphonClient,0))){
      SWIG_fail_ptr("Client_bind",1,SWIGTYPE_p_ofxSyphonClient); }  (arg1)->bind(); return SWIG_arg; fail: SWIGUNUSED; } 
  lua_error(L); return 0; }
static int _wrap_Client_unbind(lua_State* L) { { int SWIG_arg = 0; ofxSyphonClient *arg1 = (ofxSyphonClient *) 0 ;
    ...
    if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ofxSyphonClient,0))){
      SWIG_fail_ptr("Client_unbind",1,SWIGTYPE_p_ofxSyphonClient); }  (arg1)->unbind(); return SWIG_arg; fail: SWIGUNUSED; } 
  lua_error(L); return 0; }
...
static int _wrap_Server_setName(lua_State* L) { { int SWIG_arg = 0; ofxSyphonServer *arg1 = (ofxSyphonServer *) 0 ;
    ...
    if (!SWIG_IsOK(SWIG_ConvertPtr(L,1,(void**)&arg1,SWIGTYPE_p_ofxSyphonServer,0))){
      SWIG_fail_ptr("Server_setName",1,SWIGTYPE_p_ofxSyphonServer); } 
...
static int _wrap_Server_publishTexture__SWIG_1(lua_State* L) { { int SWIG_arg = 0;
    ...
    (arg1)->publishTexture(arg2,arg3,arg4,arg5,arg6); return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
...
static int _wrap_ServerDirectoryEventArgs_servers_get(lua_State* L) { { int SWIG_arg = 0;
    ...
    SWIG_NewPointerObj(L,result,SWIGTYPE_p_vectorT_ofxSyphonServerDescription_t,0); SWIG_arg++;  return SWIG_arg;
    fail: SWIGUNUSED; }  lua_error(L); return 0; }
...
static int _wrap_ServerDirectory_isValidIndex(lua_State* L) { { int SWIG_arg = 0;
    ...
    result = (bool)(arg1)->isValidIndex(arg2); lua_pushboolean(L,(int)(result!=0)); SWIG_arg++; return SWIG_arg;
    fail: SWIGUNUSED; }  lua_error(L); return 0; }
static int _wrap_ServerDirectory_serverExists__SWIG_0(lua_State* L) { { int SWIG_arg = 0;
    ...
    result = (bool)(arg1)->serverExists((std::string const &)*arg2,(std::string const &)*arg3);
    lua_pushboolean(L,(int)(result!=0)); SWIG_arg++; return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
static int _wrap_ServerDirectory_serverExists__SWIG_1(lua_State* L) { { int SWIG_arg = 0;
    ...
    result = (bool)(arg1)->serverExists((ofxSyphonServerDescription const &)*arg2);
    lua_pushboolean(L,(int)(result!=0)); SWIG_arg++; return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
static int _wrap_ServerDirectory_serverExists(lua_State* L) { int argc; int argv[4]={ 1,2,3,4} ; argc = lua_gettop(L);
  ...
  "  Possible C/C++ prototypes are:\n" "    ofxSyphonServerDirectory::serverExists(std::string const &,std::string const &)\n"
  "    ofxSyphonServerDirectory::serverExists(ofxSyphonServerDescription const &)\n"); lua_error(L);return 0; }
...
static int _wrap_ServerDirectory_handleNotification(lua_State* L) { { int SWIG_arg = 0;
    ...
    (arg1)->handleNotification(arg2,arg3); return SWIG_arg; fail: SWIGUNUSED; }  lua_error(L); return 0; }
