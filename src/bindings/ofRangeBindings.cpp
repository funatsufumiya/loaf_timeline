...
#define SWIGTYPE_p_ofRange_T_char_t swig_types[0]
#define SWIGTYPE_p_ofRange_T_double_t swig_types[1]
#define SWIGTYPE_p_ofRange_T_float_t swig_types[2]
#define SWIGTYPE_p_ofRange_T_int_t swig_types[3]
#define SWIGTYPE_p_ofRange_T_long_t swig_types[4]
...
#define SWIG_name      "ofRange"
#define SWIG_init      luaopen_ofRange
#define SWIG_init_user luaopen_ofRange_user

#define SWIG_LUACODE   luaopen_ofRange_luacode
...
extern "C" {
#endif
static int _wrap_range(lua_State* L) { { int SWIG_arg = 0; float arg1 ; float arg2 ;
    SwigValueWrapper< ofRange_< float > > result; SWIG_check_num_args("range",2,2)
    if(!lua_isnumber(L,1)) SWIG_fail_arg("range",1,"float"); if(!lua_isnumber(L,2)) SWIG_fail_arg("range",2,"float");
    arg1 = (float)lua_tonumber(L, 1); arg2 = (float)lua_tonumber(L, 2); result = range(arg1,arg2); {
      ofRange * resultptr = new ofRange(result);
      SWIG_NewPointerObj(L,(void *) resultptr,SWIGTYPE_p_ofRange_T_float_t,1); SWIG_arg++; }  return SWIG_arg;
...
static swig_type_info _swigt__p_ofRange_T_char_t = {"_p_ofRange_T_char_t", "ofCharRange *|ofRange_< char > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ofRange_T_double_t = {"_p_ofRange_T_double_t", "ofDoubleRange *|ofRange_< double > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ofRange_T_float_t = {"_p_ofRange_T_float_t", "ofFloatRange *|ofRange *|ofRange_< float > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ofRange_T_int_t = {"_p_ofRange_T_int_t", "ofIntRange *|ofRange_< int > *", 0, 0, (void*)0, 0};
static swig_type_info _swigt__p_ofRange_T_long_t = {"_p_ofRange_T_long_t", "ofLongRange *|ofRange_< long > *", 0, 0, (void*)0, 0};

static swig_type_info *swig_type_initial[] = {
  &_swigt__p_ofRange_T_char_t,
  &_swigt__p_ofRange_T_double_t,
  &_swigt__p_ofRange_T_float_t,
  &_swigt__p_ofRange_T_int_t,
  &_swigt__p_ofRange_T_long_t,
};

static swig_cast_info _swigc__p_ofRange_T_char_t[] = {  {&_swigt__p_ofRange_T_char_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ofRange_T_double_t[] = {  {&_swigt__p_ofRange_T_double_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ofRange_T_float_t[] = {  {&_swigt__p_ofRange_T_float_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ofRange_T_int_t[] = {  {&_swigt__p_ofRange_T_int_t, 0, 0, 0},{0, 0, 0, 0}};
static swig_cast_info _swigc__p_ofRange_T_long_t[] = {  {&_swigt__p_ofRange_T_long_t, 0, 0, 0},{0, 0, 0, 0}};

static swig_cast_info *swig_cast_initial[] = {
  _swigc__p_ofRange_T_char_t,
  _swigc__p_ofRange_T_double_t,
  _swigc__p_ofRange_T_float_t,
  _swigc__p_ofRange_T_int_t,
  _swigc__p_ofRange_T_long_t,
};
